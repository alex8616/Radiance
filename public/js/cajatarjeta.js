$(document).ready(function () {
    ...
    function MostrarCajaTarjeta(response) {
        ...
        $("#TotalTarjeta").text(parseFloat(response.IngresoTarjeta).toFixed(2));
    ...
    function FiltrarDatosCajaTarjeta() {
        ...
        $.ajax({
            url: "/filtrar-datos-caja-Tarjeta",
            method: "GET",
            data: {
...
function mostrarEstadoEsperaTarjeta() {
