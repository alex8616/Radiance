...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (data) {
            console.log("Sucursales deposito:", data);

            let $select = $("#sucursal_id_Deposito");
...
$(document).ready(function () {
    ...
    function MostrarCajaDeposito(response) {
        ...
        $("#EgresoDeposito").text(response.EgresoDeposito);
        $("#TotalDeposito").text(
            (
                parseFloat(response.IngresoDeposito) -
                parseFloat(response.EgresoDeposito)
            ).toFixed(2),
        );
    ...
    function FechaSelectCajaDeposito() {
        ...
        $("#sucursal_id_Deposito").on("change", function () {
            FiltrarDatosCajaDeposito();
        });
    ...
    function FiltrarDatosCajaDeposito() {
        ...
        var sucursal_id_Deposito = $("#sucursal_id_Deposito").val(); // capturamos el id

        $.ajax({
            url: "/filtrar-datos-caja-Deposito-admin",
            method: "GET",
            data: {
                ...
                fechaFin: fechaFin,
                sucursal_id_Deposito: sucursal_id_Deposito, // enviamos el id al backend
            },
